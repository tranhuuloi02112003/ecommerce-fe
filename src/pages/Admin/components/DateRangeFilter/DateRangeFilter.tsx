...
const OrderDateFilterPopover = ({ value, onApply, className = "" }: Props) => {
  ...
  return (
    <Popover className={`relative cursor-pointer ${className}`}>
      ...
      <PopoverPanel className="absolute z-50 mt-2 rounded-xl bg-white shadow-xl ring-1 ring-black/5 right-0 overflow-hidden">
        {({ close }) => (
          <div>
            <DateRange
              ranges={[
...
export default OrderDateFilterPopover;
